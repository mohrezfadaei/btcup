...
async def test_fetch_and_store_currency_rate(mocker):
    ...
    mock_influx_writer.format_data.return_value = 'currency_data,btc_rate=30000.0 1627584010000000000'
    mock_influx_writer.write_data.return_value = None
    
    service = CurrencyService(currency_repo=mock_currency_repo, influx_writer=mock_influx_writer)
    ...
    mock_influx_writer.write_data.assert_called_once_with('currency_data,btc_rate=30000.0 1627584010000000000')
